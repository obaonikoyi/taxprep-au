...
The existing app is a foundation: CSV validation, three expense categories, work-use calculations, source references, reports, browser save/resume, tests and hosting. Milestone 10 adds browser OCR, bounded document intake, evidence matching, correction and export. Milestone 11 adds a captured ATO-source register and draft phone-service rules with claim-ready output disabled. Qualified review and ongoing rule maintenance are pending. Milestone 12A adds recorded salary/wage and bank-interest inputs, withholding totals, circumstances/coverage gaps and a combined evidence handover. Milestone 12B adds a bounded fictional no-deduction employee tax calculation, including LITO and Medicare with source versions and review gates. Generative AI analysis, reliable personalised conclusions, full-return coverage and ATO integration are not implemented yet. See [Milestone 11](MILESTONE_11_PHONE_ASSESSMENT.md) for scope and the review pack. See [Milestone 10](MILESTONE_10_DOCUMENT_INTAKE.md) for the local processing design and its limitations.
...
3. **Milestone 12 — supported return preparation.** First part implemented: [Milestone 12A](MILESTONE_12A_PREPARATION_HANDOVER.md), income and coverage checks with a combined handover. [Milestone 12B](MILESTONE_12B_TAX_POSITION.md) adds a fictional tax calculation. Qualified tax/rounding review, reliable personal estimates, verified deductions and full myTax mapping remain later work. The overall milestone still covers: Income and withholding, supported personal circumstances, reliable calculations, completeness checks and a self-lodgment/agent handover. Detect rental, business, capital-gains, foreign-income and other unsupported complexity rather than omitting it.
