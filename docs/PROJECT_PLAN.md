...
| **16C-1: unified year-end preparation** | Add optional bank-deposit completeness checks and expense/evidence coverage to one session-only handover | In progress: [#54](https://github.com/obaonikoyi/taxprep-au/issues/54), under [#37](https://github.com/obaonikoyi/taxprep-au/issues/37); [scope](MILESTONE_16C1_YEAR_END_PREPARATION.md) |
