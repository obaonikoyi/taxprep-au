...
| **18: agreed pay rate checks** | Record the rate agreed in a contract, then raise specific dated arithmetic questions where a payslip disagrees with it or with itself | Designed, not implemented; extends [#35](https://github.com/obaonikoyi/taxprep-au/issues/35); [scope and safety boundaries](MILESTONE_18_AGREED_PAY_RATE.md) |
