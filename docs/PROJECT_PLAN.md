...
| **16B: annual statement extraction** | Read a documented local PDF/image annual income statement into reviewed reconciliation candidates | In progress: [#30](https://github.com/obaonikoyi/taxprep-au/issues/30), [scope](MILESTONE_16B_ANNUAL_STATEMENT_EXTRACTION.md) |
| **16C+: year-end preparation** | Connect reconciled employment income with bank/evidence questions and expense preparation | Planned under [#37](https://github.com/obaonikoyi/taxprep-au/issues/37) |
