...
</tbody></table><p>Only the entered pay pattern carries forward the entered withholding amount. TaxPrep does not scale withholding up or down for the ±20% gross scenarios and does not treat withholding as final tax.</p></section>
...
export function downloadPayOutlookReport(html: string) {
  ...
  link.href = url
  link.download = 'taxprep-pay-outlook.html'
  link.click()
